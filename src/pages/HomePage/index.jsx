...
const HomePagePage = () => {
  const [group198value, setGroup198value] = React.useState("");

  return (
    <>
      <div className="bg-blue_gray-50 flex flex-col font-notoseriftamil items-center justify-start mx-auto w-full">
        <div className="h-[1080px] sm:h-[1081px] md:h-[1946px] md:px-5 relative w-full">
          <div className="h-[1080px] sm:h-[1081px] md:h-[1946px] m-auto w-full">
            <Img
              className="h-[1080px] m-auto object-cover w-full"
              src="images/img_project1petrolpump.png"
              alt="project1petrolp"
            />
            <div className="absolute bg-gradient2  flex flex-col h-full inset-[0] items-center justify-center m-auto pb-[42px] w-full">
              <div className="flex flex-col items-center justify-start w-full">
                ...
                <Input
                  ...
                  wrapClassName="flex mt-[143px] rounded-md w-[45%]"
                  suffix={
                    group198value?.length > 0 ? (
                      <CloseSVG
                        className="cursor-pointer h-6 ml-[35px] my-0.5"
                        onClick={() => setGroup198value("")}
                        fillColor="#e2e2e2"
                        height={24}
                        width={24}
                        viewBox="0 0 24 24"
                  ...
                  variant="outline"
                ></Input>
                <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[135px] w-[90%] md:w-full">
                  <div className="flex flex-col items-start justify-start w-[43%] md:w-full">
                    ...
                    <Text
                      className="leading-[200.00%] ml-0.5 md:ml-[0] mt-5 text-base text-gray-300 tracking-[0.48px]"
                    ...
                    <Button
                      className="cursor-pointer font-medium leading-[normal] min-w-[267px] ml-0.5 md:ml-[0] mt-9 text-center text-sm tracking-[0.42px]"
                      shape="round"
                      color="yellow_800"
                      size="md"
                      variant="outline"
                  ...
                  <List
                    className="sm:flex-col flex-row gap-[21px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 md:mt-0 mt-[235px] w-[41%] md:w-full"
                    orientation="horizontal"
                  >
                    <div className="bg-blue_gray-100 flex flex-col items-center justify-start outline outline-[3px] outline-gray-300 rounded-[5px] w-full">
          ...
          <header className="absolute bg-gray-800_71 flex md:flex-col flex-row md:gap-5 inset-x-[0] items-center justify-center mx-auto top-[4%] w-full">
            ...
            <ul className="flex md:flex-1 sm:flex-col flex-row sm:hidden items-start justify-center md:ml-[0] ml-[497px] md:mt-0 my-[21px] w-1/5 md:w-full common-row-list">
              <li>
                <a
                  href="javascript:"
                  className="mt-0.5 text-gray-300 text-sm hover:text-yellow-800 tracking-[0.42px]"
                >
                  <Text size="txtNotoSerifTamilMedium14Gray300">Home</Text>
                </a>
              </li>
              <li>
                <a
                  href="javascript:"
                  className="ml-[67px] text-gray-300 text-sm hover:text-yellow-800 tracking-[0.42px]"
                >
                  <Text size="txtNotoSerifTamilMedium14Gray300">About US</Text>
                </a>
              </li>
              <li>
                <a
                  href="javascript:"
                  className="ml-[68px] text-lg text-yellow-800 tracking-[0.54px]"
                >
                  <Text size="txtNotoSerifTamilMedium18Yellow800">Shop</Text>
                </a>
              </li>
              <li>
                <a
                  href="javascript:"
                  className="ml-14 mt-[3px] text-gray-300 text-sm hover:text-yellow-800 tracking-[0.42px]"
                >
            ...
            <Button
              className="cursor-pointer font-medium leading-[normal] min-w-[136px] ml-5 md:ml-[0] mr-[100px] md:mt-0 my-3 text-center text-sm tracking-[0.42px]"
              shape="round"
              color="gray_300"
              size="md"
              variant="outline"
        ...
        <div className="md:h-[1528px] h-[563px] sm:h-[697px] max-w-[1719px] mt-[57px] mx-auto md:px-5 relative w-full">
          <div className="absolute bottom-[0] flex flex-col gap-[18px] inset-x-[0] items-center justify-start mx-auto w-full">
            <Text
            ...
            >
              <span className="text-gray-600 font-notoseriftamil font-normal">
                <>
                  We believe in the power of brands to create credibility.
                  That’s why we partner with the best to bring you top-quality
                  products. Trust us to deliver excellence, every time.
                  <br />
                </>
              </span>
              <span className="text-gray-600 font-notoseriftamil font-normal">
          ...
          <div className="absolute bg-blue_gray-100 h-[177px] right-[7%] top-[0] w-[2%]"></div>
        </div>
