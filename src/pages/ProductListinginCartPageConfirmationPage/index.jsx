...
const ProductListinginCartPageConfirmationPagePage = () => {
  const [group469value, setGroup469value] = React.useState("");
    ...
    <>
      <div className="bg-blue_gray-50 flex flex-col font-notoseriftamil items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-start justify-start w-full">
          ...
          <Text
            className="md:ml-[0] ml-[100px] mt-8 text-gray-600 text-lg tracking-[0.54px]"
          ...
          <div className="bg-blue_gray-100 flex sm:flex-col flex-row sm:gap-5 items-start justify-start mt-[27px] p-[13px] w-full">
            <Text
          ...
          <div className="h-[1129px] md:h-[3497px] md:px-5 relative w-full">
            <div className="h-[1129px] md:h-[3497px] m-auto w-full">
              ...
              <div className="absolute flex md:flex-col flex-row md:gap-5 h-full inset-y-[0] items-center justify-start left-[9%] my-auto w-1/2">
            ...
            <Line className="absolute bg-gray-600 h-[1129px] inset-y-[0] my-auto right-[17%] w-px" />
            <div className="absolute flex md:flex-col flex-row md:gap-10 gap-[72px] items-start justify-center right-[18%] top-[3%] w-[56%]">
              <div className="bg-gray-800_ae flex flex-col gap-7 items-center justify-end mb-[281px] md:mt-0 mt-[81px] p-[70px] md:px-10 sm:px-5 rounded-[16px] w-[77%] md:w-full">
                <div className="flex flex-col items-center justify-start mt-6 w-[64%] md:w-full">
                  <Img
                    className="h-[50px]"
                  ...
                  />
                  <Text
                    className="mt-6 text-lg text-white-A700 tracking-[0.54px]"
                    size="txtNotoSerifTamilMedium18WhiteA700"
                  >
                    Thank you For Sending Quotation
                  </Text>
                  <Text
                    className="mt-3.5 text-3xl sm:text-[26px] md:text-[28px] text-white-A700 tracking-[0.90px]"
                    size="txtNotoSerifTamilBold30"
                  >
                    Sunrise Oasis Lighting LLC
                  </Text>
                  <Text
                    className="mt-3 text-lg text-white-A700 tracking-[0.54px]"
                    size="txtNotoSerifTamilMedium18WhiteA700"
                  >
                    We will contact you in min.
                  </Text>
                </div>
                <Button
                  className="cursor-pointer font-medium leading-[normal] min-w-[204px] rounded text-center text-sm tracking-[0.42px]"
              ...
              <div className="flex flex-col md:gap-10 gap-[695px] items-center justify-start w-[17%] md:w-full">
...
export default ProductListinginCartPageConfirmationPagePage;
